<!-- filepath: c:\Users\fevek\Herd\klussendienst\resources\views\auth\register.blade.php -->
...
<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="street" class="block mt-1 w-full" type="text" name="street" :value="old('street')" required autocomplete="street-address" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="housenumber" class="block mt-1 w-full" type="text" name="housenumber" :value="old('housenumber')" required autocomplete="address-line2" />
        ...
        <div class="mt-4">
            ...
            <select id="role" name="role" class="block mt-1 w-full border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" required>
